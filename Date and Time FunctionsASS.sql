...
use sakila ;
select year(rental_date ) as yearss ,
monthname(rental_date) as months,
day(rental_date) as days
from rental ;
...
from rental 
where rental_date  is not null and datediff(return_date,rental_date) >5 
;
                                               ###########################
